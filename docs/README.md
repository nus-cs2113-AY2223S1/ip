...
2. Download the latest iP.jar from [here](https://github.com/LokQiJun/ip/releases)


3. Copy the iP.jar file to an empty folder.
...
A: Transfer the text file named "Tasks.txt", located in the same directory as your iP.jar file, over to your other computer. Place it in the same directory as the iP.jar file on your other computer. Your tasks will then be loaded from this text file when you run iP.jar on your new computer.
