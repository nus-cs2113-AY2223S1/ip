...
public class Storage {
     ...
     * Throws an error if the file is not found and creates a new task list if the
     * file is empty
     * 
    ...
    /**
     * Get tasks from the task list and write them in a different format to be
     * displayed
     * in the data file
     * 
     ...
     * 
     * @param textToAppend task details in specific file format to be added to the
     *                     data file
     */
