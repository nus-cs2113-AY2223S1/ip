...
/**
 * <code>TodoCommand</code> is the command that adds a to-do task into the task list.
 */
public class TodoCommand extends AddCommand {
    ...
    /**
     * Checks that user input contains a description.
     *
     * @param parameterInput The extracted part of user input after the command entered.
     * @throws DukeException Exception triggered on invalid user input.
     */
    ...
    /**
     * Creates a to-do task and add it to the task list.
